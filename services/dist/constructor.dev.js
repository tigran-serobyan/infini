...
module.exports = {
  ...
  changeTitleAM: changeTitleAM,
  changeTitleEN: changeTitleEN,
  changeLogoAM: changeLogoAM,
  changeLogoEN: changeLogoEN,
  changeNavigationAM: changeNavigationAM,
  changeNavigationEN: changeNavigationEN,
  findPortfolioCategories: findPortfolioCategories,
  changePortfolioCategories: changePortfolioCategories,
  getHomeAM: getHomeAM,
  changeHomeAM: changeHomeAM,
  getHomeEN: getHomeEN,
  changeHomeEN: changeHomeEN,
  changeFooterAM: changeFooterAM,
  changeFooterEN: changeFooterEN,
  getTexts: getTexts,
